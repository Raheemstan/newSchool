...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/ui-tab.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Oct 2023 04:25:12 GMT -->
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                ...
                                <li class="nav-item">
                                    <a href="ui-tab.php" class="nav-link menu-active"><i class="fas fa-angle-right"></i>Tab</a>
                                </li>
                                <li class="nav-item">
