...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/ui-widget.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Oct 2023 04:25:12 GMT -->
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="item-content">
                                <ul class="settings-list">
                                    ...
                                    <li>
                                        <a href="#"><i class="flaticon-chat-comment-oval-speech-bubble-with-text-lines"></i>Message</a>
                                    </li>
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                ...
                                <li class="nav-item">
                                    <a href="ui-widget.php" class="nav-link menu-active"><i class="fas fa-angle-right"></i>Widget</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
