...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/class-routine.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Oct 2023 04:25:12 GMT -->
            ...
            <div class="sidebar-main sidebar-menu-one sidebar-expand-md sidebar-color">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item">
                            <a href="class-routine.php" class="nav-link menu-active"><i class="flaticon-calendar"></i><span class="menu-active">Class
                                    Routine</span></a>
                        </li>
                        <li class="nav-item">
