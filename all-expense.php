...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/all-expense.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Oct 2023 04:25:12 GMT -->
                    ...
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        ...
                        <li class="nav-item sidebar-nav-item">
                            ...
                            <ul class="nav sub-group-menu sub-group-active">
                                ...
                                <li class="nav-item">
                                    <a href="all-expense.php" class="nav-link menu-active"><i class="fas fa-angle-right"></i>Expenses</a>
                                </li>
                                <li class="nav-item">
